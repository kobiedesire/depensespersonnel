 ...
 * @author hp
 */
public class InterfaceElementsDeSalaire extends javax.swing.JDialog {

    /**
     * Creates new form InterfaceListeLigne
     */
    public InterfaceElementsDeSalaire(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    //Lister toutes les agents********************************************************************************************************************
    public static void afficherSal() {
        AgentModifController.afficherElementDeSalaire(); 
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Elements de salaire de l'agent", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 0, 14))); // NOI18N

        tableau_elementSalaire.setAutoCreateRowSorter(true);
        tableau_elementSalaire.setFont(new java.awt.Font("Liberation Sans", 0, 16)); // NOI18N
        tableau_elementSalaire.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "ID Agent", "Matricule", "Indice", "Salaire indiciaire", "Ind.Résidence", "Ind.Astreinte", "Ind.Technicite", "Ind.Responsabilité", "Ind.Vestimentaire", "Ind.Logement", "Ind.Specifique", "Autres.Ind", "Charge militaire", "CARFO", "CNSS", "Allocations Fam."
            }
        ) {
        ...
        tableau_elementSalaire.setSelectionBackground(new java.awt.Color(255, 153, 0));
        tableau_elementSalaire.setSelectionForeground(new java.awt.Color(255, 255, 255));
        tableau_elementSalaire.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tableau_elementSalaireMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tableau_elementSalaire);
        if (tableau_elementSalaire.getColumnModel().getColumnCount() > 0) {
            tableau_elementSalaire.getColumnModel().getColumn(0).setMinWidth(0);
            tableau_elementSalaire.getColumnModel().getColumn(0).setPreferredWidth(0);
    ...
    private void tableau_elementSalaireMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableau_elementSalaireMouseClicked
     ...
     //   if (evt.getClickCount() == 2 && !evt.isConsumed()) {
       //     evt.consume();
           ...
           // this.dispose();
        //}
    }//GEN-LAST:event_tableau_elementSalaireMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfaceElementsDeSalaire.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                InterfaceElementsDeSalaire dialog = new InterfaceElementsDeSalaire(new javax.swing.JFrame(), true);
