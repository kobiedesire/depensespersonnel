 ...
 * @author hp
 */
public class InterfaceListeLigne661Contractuel extends javax.swing.JDialog {

    /**
     * Creates new form InterfaceListeLigne
     */
    public InterfaceListeLigne661Contractuel(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    //Lister toutes les agents********************************************************************************************************************
    public static void listerLignes() {
        ContractuelController.afficherLignesFromProgramme661(); 
    }
    
    //afficher l'id de la ligne dans le formulaire agent
    public static void afficherIDLigne661() {
        ContractuelController.recupIDLigne661(); 
    }
   ...
   /* public static void afficherIDLigne663() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfaceListeLigne661Contractuel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                InterfaceListeLigne661Contractuel dialog = new InterfaceListeLigne661Contractuel(new javax.swing.JFrame(), true);
