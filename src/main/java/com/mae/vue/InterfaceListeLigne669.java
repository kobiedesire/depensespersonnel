 ...
 * @author hp
 */
public class InterfaceListeLigne669 extends javax.swing.JDialog {

    /**
     * Creates new form InterfaceListeLigne
     */
    public InterfaceListeLigne669(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    //Lister toutes les agents********************************************************************************************************************
    public static void listerLignes() {
        AgentController.afficherLignesFromProgramme669(); 
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfaceListeLigne669.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                InterfaceListeLigne669 dialog = new InterfaceListeLigne669(new javax.swing.JFrame(), true);
