...
import com.mae.controller.EmploiController;
 ...
 * @author kobie
 */
public class InterfaceEmploi extends javax.swing.JInternalFrame {

    /**
     *
     */
    public InterfaceEmploi() {
        initComponents();
    ...
    public static void enregistrerEmploi() {
        // Récuperation des donnéses du formulaire
        String eCode = codeEmpl.getText().trim();
        String eLibele = libeleEmpl.getText().trim();
        if (eCode.isBlank() || eLibele.isBlank()) {
            JOptionPane.showMessageDialog(null, "Des cahmps sont vides");
        } else {
            Emploi emploi = new Emploi(eCode, eLibele); // Créez un objet InterfaceStructure     
            EmploiController.saveEmploi(emploi);  // Enregistrez  dans la base de données        
            codeEmpl.setText("");
            libeleEmpl.setText("");
    ...
    public static void listerEmploi() {
        EmploiController.listAll(); // Executer la méthode d'affichage des données  
    }
    ...
    public static void afficherEmploi() {
        EmploiController.displayEmploi();// Executer la méthode d'affichage des données        
    }

    //Modifier une structure********************************************************************************************************************
    public static void modifierEmploi() {
        // Récuperation des donnéses du formulaire
        String eCode = codeEmpl.getText().trim();
        String eLibele = libeleEmpl.getText().trim();
        ...
        if (eCode.isBlank() || eLibele.isBlank()) {
            ...
            rep = JOptionPane.showConfirmDialog(null, "Voulez-vous vraiment modifier cet emploi?", "Modification d'un emploi", JOptionPane.YES_NO_OPTION);
            if (rep == JOptionPane.YES_OPTION) {
                Emploi emploi = new Emploi(eCode, eLibele);
                EmploiController.updateEmploi(emploi); // Executer la méthode de modification dans la base de données
    ...
    public static void supprimerEmploi() {
        rep = JOptionPane.showConfirmDialog(null, "Voulez-vous vraiment supprimer cet emploi?", "Suppression d'un emploi", JOptionPane.YES_NO_OPTION);
        if (rep == JOptionPane.YES_OPTION) {
            Emploi emploi = new Emploi();
            EmploiController.deleteEmploi(emploi);// Executer la méthode de suppression des données    
            JOptionPane.showMessageDialog(null, "Emploi supprimé");
            codeEmpl.setText("");
            libeleEmpl.setText("");
    ...
    private void initComponents() {
        ...
        codeEmpl = new javax.swing.JTextField();
        libeleEmpl = new javax.swing.JTextField();
        jLabel1 = new javax.swing.JLabel();
        jScrollPane1 = new javax.swing.JScrollPane();
        tableau_emploi = new javax.swing.JTable();
        ...
        setIconifiable(true);
        setMaximizable(true);
        setTitle("Gestion des emplois des agents");
        setFrameIcon(null);
        ...
        panneauForms.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Informations sur l'emploi", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 0, 14))); // NOI18N

        jLabel3.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jLabel3.setText("Code Emploi : ");

        codeEmpl.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N

        jLabel1.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jLabel1.setText("Libélé Emploi");
        ...
        panneauFormsLayout.setHorizontalGroup(
            ...
            .addGroup(panneauFormsLayout.createSequentialGroup()
                ...
                .addComponent(codeEmpl, javax.swing.GroupLayout.PREFERRED_SIZE, 415, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLabel1)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(libeleEmpl)
                .addContainerGap())
        );
        panneauFormsLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panneauFormsLayout.createSequentialGroup()
                ...
                .addGroup(panneauFormsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(panneauFormsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(jLabel3)
                        .addComponent(codeEmpl, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(51, 51, 51))
        );

        tableau_emploi.setAutoCreateRowSorter(true);
        tableau_emploi.setFont(new java.awt.Font("Liberation Sans", 0, 16)); // NOI18N
        tableau_emploi.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null},
                {null, null, null},
                {null, null, null},
            ...
            new String [] {
                "ID Emploi", "Code Emploi", "Libélé Emploi"
            }
        ) {
        ...
        tableau_emploi.setSelectionBackground(new java.awt.Color(255, 153, 0));
        tableau_emploi.setSelectionForeground(new java.awt.Color(255, 255, 255));
        tableau_emploi.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tableau_emploiMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tableau_emploi);
        if (tableau_emploi.getColumnModel().getColumnCount() > 0) {
            tableau_emploi.getColumnModel().getColumn(0).setMinWidth(0);
            tableau_emploi.getColumnModel().getColumn(0).setPreferredWidth(0);
            tableau_emploi.getColumnModel().getColumn(0).setMaxWidth(0);
        }
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        ...
        //listerProgramme();
        // listerComboBudget();
        JTableHeader header = tableau_emploi.getTableHeader();
        header.setDefaultRenderer(new PropsTableau());
    }//GEN-LAST:event_formInternalFrameOpened

    private void tableau_emploiMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableau_emploiMouseClicked
        // TODO add your handling code here:
        afficherEmploi();
    }//GEN-LAST:event_tableau_emploiMouseClicked
    ...
    public static javax.swing.JTextField codeEmpl;
    private javax.swing.JLabel jLabel1;
    private javax.swing.JLabel jLabel3;
    private javax.swing.JPanel jPanel1;
    private javax.swing.JScrollPane jScrollPane1;
    public static javax.swing.JTextField libeleEmpl;
    public static javax.swing.JPanel panneauForms;
    public static javax.swing.JPanel panneauPrincipal;
    public static javax.swing.JTable tableau_emploi;
