 ...
 * @author hp
 */
public class InterfaceListeLigne664AmbassadeurConsul extends javax.swing.JDialog {

    /**
     * Creates new form InterfaceListeLigne
     */
    public InterfaceListeLigne664AmbassadeurConsul(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    //Lister toutes les agents********************************************************************************************************************
    public static void listerLignes() {
        AmbassadeurConsulController.afficherLignesFromProgramme664(); 
    }
    
    //afficher l'id de la ligne dans le formulaire agent
     public static void afficherIDLigne664() {
        AmbassadeurConsulController.recupIDLigne664(); 
    }
   ...
   /* public static void afficherIDLigne661() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfaceListeLigne664AmbassadeurConsul.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                InterfaceListeLigne664AmbassadeurConsul dialog = new InterfaceListeLigne664AmbassadeurConsul(new javax.swing.JFrame(), true);
