...
import com.mae.controller.MinistereController;
 ...
 * @author kobie
 */
public class InterfaceMinistere extends javax.swing.JInternalFrame {
    ...
    public static void enregistrerMinistere() {
        // Récuperation des donnéses du formulaire
        String mCode = codeMin.getText().trim();
        String mLibele = libeleMin.getText().trim();
        if (mCode.isBlank() || mLibele.isBlank()) {
            JOptionPane.showMessageDialog(null, "Des cahmps sont vides");
        } else {
            Ministere ministere = new Ministere(mCode, mLibele); // Créez un objet InterfaceStructure     
            MinistereController.saveMinistere(ministere);  // Enregistrez  dans la base de données        
            codeMin.setText("");
            libeleMin.setText("");
    ...
    public static void listerMinistere() {
        MinistereController.listAll(); // Executer la méthode d'affichage des données  
    }
    ...
    public static void afficherMinistere() {
        MinistereController.displayMinistere();// Executer la méthode d'affichage des données        
    }

    //Modifier une structure********************************************************************************************************************
    public static void modifierMinistere() {
        // Récuperation des donnéses du formulaire
        String mCode = codeMin.getText().trim();
        String mLibele = libeleMin.getText().trim();
        ...
        if (mCode.isBlank() || mLibele.isBlank()) {
            ...
            rep = JOptionPane.showConfirmDialog(null, "Voulez-vous vraiment modifier ce Ministère?", "Modification d'un Ministère", JOptionPane.YES_NO_OPTION);
            if (rep == JOptionPane.YES_OPTION) {
                Ministere ministere = new Ministere(mCode, mLibele);
                MinistereController.updateMinistere(ministere); // Executer la méthode de modification dans la base de données
    ...
    public static void supprimerMinistere() {
        rep = JOptionPane.showConfirmDialog(null, "Voulez-vous vraiment supprimer ce Ministère?", "Suppression d'un Ministère", JOptionPane.YES_NO_OPTION);
        if (rep == JOptionPane.YES_OPTION) {
            Ministere ministere = new Ministere();
            MinistereController.deleteMinistere(ministere);// Executer la méthode de suppression des données    
            JOptionPane.showMessageDialog(null, "Ministère supprimé");
            codeMin.setText("");
            libeleMin.setText("");
    ...
    private void initComponents() {
        ...
        codeMin = new javax.swing.JTextField();
        libeleMin = new javax.swing.JTextField();
        jLabel1 = new javax.swing.JLabel();
        jScrollPane1 = new javax.swing.JScrollPane();
        tableau_ministere = new javax.swing.JTable();
        ...
        setIconifiable(true);
        setMaximizable(true);
        setTitle("Gestion des ministères");
        setFrameIcon(null);
        ...
        panneauForms.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Informations sur le minisètre", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 0, 14))); // NOI18N

        jLabel3.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jLabel3.setText("Code Ministère : ");

        codeMin.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N

        jLabel1.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jLabel1.setText("Libélé Ministère");
        ...
        panneauFormsLayout.setHorizontalGroup(
            ...
            .addGroup(panneauFormsLayout.createSequentialGroup()
                ...
                .addComponent(codeMin, javax.swing.GroupLayout.PREFERRED_SIZE, 415, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLabel1)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(libeleMin)
                .addContainerGap())
        );
        panneauFormsLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panneauFormsLayout.createSequentialGroup()
                ...
                .addGroup(panneauFormsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(panneauFormsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(jLabel3)
                        .addComponent(codeMin, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(51, 51, 51))
        );

        tableau_ministere.setAutoCreateRowSorter(true);
        tableau_ministere.setFont(new java.awt.Font("Liberation Sans", 0, 16)); // NOI18N
        tableau_ministere.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null},
                {null, null, null},
                {null, null, null},
            ...
            new String [] {
                "ID Ministère", "Code Ministère", "Libélé Ministère"
            }
        ) {
        ...
        tableau_ministere.setSelectionBackground(new java.awt.Color(255, 153, 0));
        tableau_ministere.setSelectionForeground(new java.awt.Color(255, 255, 255));
        tableau_ministere.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tableau_ministereMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tableau_ministere);
        if (tableau_ministere.getColumnModel().getColumnCount() > 0) {
            tableau_ministere.getColumnModel().getColumn(0).setMinWidth(0);
            tableau_ministere.getColumnModel().getColumn(0).setPreferredWidth(0);
            tableau_ministere.getColumnModel().getColumn(0).setMaxWidth(0);
        }
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        ...
        //listerProgramme();
        // listerComboBudget();
        JTableHeader header = tableau_ministere.getTableHeader();
        header.setDefaultRenderer(new PropsTableau());
    }//GEN-LAST:event_formInternalFrameOpened

    private void tableau_ministereMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableau_ministereMouseClicked
        // TODO add your handling code here:
        afficherMinistere();
    }//GEN-LAST:event_tableau_ministereMouseClicked
    ...
    public static javax.swing.JTextField codeMin;
    private javax.swing.JLabel jLabel1;
    private javax.swing.JLabel jLabel3;
    private javax.swing.JPanel jPanel1;
    private javax.swing.JScrollPane jScrollPane1;
    public static javax.swing.JTextField libeleMin;
    public static javax.swing.JPanel panneauForms;
    public static javax.swing.JPanel panneauPrincipal;
    public static javax.swing.JTable tableau_ministere;
