...
import com.mae.controller.CategorieEchelleController;
 ...
 * @author kobie
 */
public class InterfaceCategorieEchelle extends javax.swing.JInternalFrame {

    /**
     *
     */
    public InterfaceCategorieEchelle() {
        initComponents();
    ...
    public static void enregistrerCategorieEchelle() {
        // Récuperation des donnéses du formulaire
        String cCode = codeCateEch.getText().trim();
        if (cCode.isBlank()) {
            JOptionPane.showMessageDialog(null, "Des cahmps sont vides");
        } else {
            CategorieEchelle categorieechelle = new CategorieEchelle(cCode); // Créez un objet InterfaceStructure     
            CategorieEchelleController.saveCategorieEchelle(categorieechelle);  // Enregistrez  dans la base de données        
            codeCateEch.setText("");
    ...
    public static void listerCategorieEchelle() {
        CategorieEchelleController.listAll(); // Executer la méthode d'affichage des données  
    }
  ...
  /*  public static void listerComboBudget() {
    ...
    public static void afficherCategorieEchelle() {
        CategorieEchelleController.displayCategorieEchelle();// Executer la méthode d'affichage des données        
    }

    //Modifier une structure********************************************************************************************************************
    public static void modifierCategorieEchelle() {
        // Récuperation des donnéses du formulaire
        String cCode = codeCateEch.getText().trim();
        ...
        if (cCode.isBlank()) {
            ...
            rep = JOptionPane.showConfirmDialog(null, "Voulez-vous vraiment modifier cette catégorie?", "Modification d'une catégorie", JOptionPane.YES_NO_OPTION);
            if (rep == JOptionPane.YES_OPTION) {
                CategorieEchelle categorieechelle = new CategorieEchelle(cCode);
                CategorieEchelleController.updateCategorieEchelle(categorieechelle); // Executer la méthode de modification dans la base de données
    ...
    public static void supprimerCategorieEchelle() {
        rep = JOptionPane.showConfirmDialog(null, "Voulez-vous vraiment supprimer cette catégorie?", "Suppression d'une catégorie", JOptionPane.YES_NO_OPTION);
        if (rep == JOptionPane.YES_OPTION) {
            CategorieEchelle categorieechelle = new CategorieEchelle();
            CategorieEchelleController.deleteCategorieEchelle(categorieechelle);// Executer la méthode de suppression des données    
    ...
    private void initComponents() {
        ...
        codeCateEch = new javax.swing.JTextField();
        idCatE = new javax.swing.JTextField();
        jScrollPane1 = new javax.swing.JScrollPane();
        tableau_categorie = new javax.swing.JTable();
        ...
        setIconifiable(true);
        setMaximizable(true);
        setTitle("Gestion des catégories des agents");
        setFrameIcon(null);
        ...
        panneauForms.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Informations sur la catégorie et l'échelle", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 0, 14))); // NOI18N

        jLabel3.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jLabel3.setText("Code Catégorie/Echelle : ");

        codeCateEch.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
            ...
            .addGroup(panneauFormsLayout.createSequentialGroup()
                ...
                .addGroup(panneauFormsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(panneauFormsLayout.createSequentialGroup()
                        ...
                        .addComponent(codeCateEch, javax.swing.GroupLayout.PREFERRED_SIZE, 415, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        panneauFormsLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panneauFormsLayout.createSequentialGroup()
                ...
                .addGroup(panneauFormsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
                    .addComponent(codeCateEch, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(idCatE)
                .addGap(23, 23, 23))
        );

        tableau_categorie.setAutoCreateRowSorter(true);
        tableau_categorie.setFont(new java.awt.Font("Liberation Sans", 0, 16)); // NOI18N
        tableau_categorie.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null},
                {null, null},
                {null, null},
            ...
            new String [] {
                "ID Cat/Echelle", "Code Catégorie/Echelle"
            }
        ) {
        ...
        tableau_categorie.setSelectionBackground(new java.awt.Color(255, 153, 0));
        tableau_categorie.setSelectionForeground(new java.awt.Color(255, 255, 255));
        tableau_categorie.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tableau_categorieMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tableau_categorie);
        if (tableau_categorie.getColumnModel().getColumnCount() > 0) {
            tableau_categorie.getColumnModel().getColumn(0).setMinWidth(0);
            tableau_categorie.getColumnModel().getColumn(0).setPreferredWidth(0);
            tableau_categorie.getColumnModel().getColumn(0).setMaxWidth(0);
        }
    ...
    private void btn_enregistrerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_enregistrerActionPerformed
        enregistrerCategorieEchelle();
        listerCategorieEchelle();
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        ...
        //listerProgramme();
       // listerComboBudget();
        JTableHeader header = tableau_categorie.getTableHeader();
        header.setDefaultRenderer(new PropsTableau());
    }//GEN-LAST:event_formInternalFrameOpened

    private void tableau_categorieMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableau_categorieMouseClicked
        // TODO add your handling code here:
        afficherCategorieEchelle();
    }//GEN-LAST:event_tableau_categorieMouseClicked

    private void btn_modifierActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_modifierActionPerformed
        // TODO add your handling code here:
        modifierCategorieEchelle();
        listerCategorieEchelle();
    }//GEN-LAST:event_btn_modifierActionPerformed

    private void btn_supprimerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_supprimerActionPerformed
        // TODO add your handling code here:
        supprimerCategorieEchelle();
        listerCategorieEchelle();
    ...
    public static javax.swing.JTextField codeCateEch;
    ...
    public static javax.swing.JTable tableau_categorie;
