 ...
 * @author hp
 */
public class InterfaceListeLigne669AmbassadeurConsul extends javax.swing.JDialog {

    /**
     * Creates new form InterfaceListeLigne
     */
    public InterfaceListeLigne669AmbassadeurConsul(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    //Lister toutes les agents********************************************************************************************************************
    public static void listerLignes() {
        AmbassadeurConsulController.afficherLignesFromProgramme669(); 
    }
    ...
    public static void afficherIDLigne669() {
        AmbassadeurConsulController.recupIDLigne669(); 
    }
    /**
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfaceListeLigne669AmbassadeurConsul.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                InterfaceListeLigne669AmbassadeurConsul dialog = new InterfaceListeLigne669AmbassadeurConsul(new javax.swing.JFrame(), true);
