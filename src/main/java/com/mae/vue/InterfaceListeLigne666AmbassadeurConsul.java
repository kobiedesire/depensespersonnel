 ...
 * @author hp
 */
public class InterfaceListeLigne666AmbassadeurConsul extends javax.swing.JDialog {

    /**
     * Creates new form InterfaceListeLigne
     */
    public InterfaceListeLigne666AmbassadeurConsul(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    //Lister toutes les agents********************************************************************************************************************
    public static void listerLignes() {
        AmbassadeurConsulController.afficherLignesFromProgramme666(); 
    }
    
    //afficher l'id de la ligne dans le formulaire agent
    
     public static void afficherIDLigne666() {
        AmbassadeurConsulController.recupIDLigne666(); 
    }
   /* public static void afficherIDLigne661() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(btn_ajout666, javax.swing.GroupLayout.PREFERRED_SIZE, 165, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfaceListeLigne666AmbassadeurConsul.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                InterfaceListeLigne666AmbassadeurConsul dialog = new InterfaceListeLigne666AmbassadeurConsul(new javax.swing.JFrame(), true);
